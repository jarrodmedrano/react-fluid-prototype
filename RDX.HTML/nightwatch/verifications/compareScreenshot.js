// verify/compareScreenshot.js
var resemble = require('node-resemble-js'),
    fs = require('fs');

exports.verification = function(filename, expected) {
    var screenshotPath = 'nightwatch/screenshots/',
    ...
    this.command = function(callback) {
        ...
        resemble(baselinePath).compareTo(resultPath).ignoreAntialiasing().onComplete(callback);
        //resemble
    ...
    this.value = function(result) {
        ...
        var diff = result.getDiffImage().pack().pipe(
