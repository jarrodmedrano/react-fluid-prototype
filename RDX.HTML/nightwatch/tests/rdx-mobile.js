module.exports = {
    ...
    'RDX Page 1 Slide 1': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page1-slide-1.png')
            .end();
    },
    'RDX Page 1 Slide 2': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page1-slide-2.png')
            .end();
    },
    'RDX Page 1 Slide 3': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page1-slide-3.png')
            .end();
    },
    'RDX Page 1 Slide 4': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page1-slide-4.png')
            .end();
    },
    'RDX Page 2 Slide 0': function(browser) {
        browser
            ...
            .pause(1000)
            .compareScreenshot('RDX-mobile-page2-slide-0.png')
            .end();
    },
    'RDX Page 2 Slide 1': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page2-slide-1.png')
            .end();
    },
    'RDX Page 2 Slide 2': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page2-slide-2.png')
            .end();
    },
    'RDX Page 2 Slide 3': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page2-slide-3.png')
            .end();
    },
    'RDX Page 3 Slide 0': function(browser) {
        browser
            ...
            .pause(1000)
            .compareScreenshot('RDX-mobile-page3-slide-0.png')
            .end();
    },
    'RDX Page 3 Slide 1': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page3-slide-1.png')
            .end();
    },
    'RDX Page 3 Slide 2': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page3-slide-2.png')
            .end();
    },
    'RDX Page 3 Slide 3': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page3-slide-3.png')
            .end();
    },
    'RDX Page 4 Slide 1': function(browser) {
        browser
            ...
            .pause(1000)
            .compareScreenshot('RDX-mobile-page4-slide-1.png')
            .end();
    },
    'RDX Page 4 Slide 2': function(browser) {
        browser
            ...
            .click('.rightNav')
            .pause(1000)
            .compareScreenshot('RDX-mobile-page4-slide-2.png')
            .end();
    },
    'RDX Page 5 Slide 1': function(browser) {
        browser
            ...
            .pause(1000)
            .compareScreenshot('RDX-mobile-page5-slide-1.png')
            .end();
    }
};